...
def main():
    ...
    diminishing_weight = False              # False to not use the discounted weight for noise in late episodes
    ...
    for i in range(run):
        goals = qLearning(env,num_episode,gamma,learning_rate,game_step,punish,discount_noise,punish_val,diminishing_weight)
